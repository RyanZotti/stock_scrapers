...
public class AdvfnNasdaqSymbolScraper {
	public static void main(String[] args){
		...
		try {
			...
			while(rs.next()){
				...
				String webUrl = "http://www.advfn.com/nasdaq/nasdaq.asp?companies="+letter;
				driver = new FirefoxDriver();
				driver.get(webUrl);
				Document document = Jsoup.parse(driver.getPageSource());
				Elements trs = document.select("b:containsOwn(Companies listed on the NASDAQ)")
